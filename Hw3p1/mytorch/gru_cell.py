...
class GRUCell(object):
    ...
    def __init__(self, input_size, hidden_size, autograd_engine):
        ...
        self.r_cell = RNNCell(input_size, hidden_size, self.autograd_engine, act_fn=Sigmoid)
        self.z_cell = RNNCell(input_size, hidden_size, self.autograd_engine, act_fn=Sigmoid)
        self.n_cell = RNNCell(input_size, hidden_size, self.autograd_engine, act_fn=Tanh)
    ...
    def forward(self, x, h_prev_t):
        ...
        self.r = self.r_cell(x, h_prev_t)
        self.z = self.z_cell(x, h_prev_t)
        self.n = self.n_cell(x, h_prev_t, scale_hidden=self.r)
